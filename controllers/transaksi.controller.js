...
exports.showFormTransaksi = async (request, response) => {
    try {
        ...
        /** ambil data member */
        let member = await memberModel.findAll() /** mengambil data dari database */
        ...
        let sendData = {
            ...
            page: `form-transaksi`,
            tgl_transaksi: ``,
            dataTelurString: JSON.stringify(telur), //  stringify : mengubah array menjadi string
...
/** membuat function untuk menghapus data transaksi */
